...
public:
    ...
    void setupUi(QDialog *dial_control_par)
    {
        ...
        ed_thick = new param_ed_arr(dial_control_par);
        ...
        ed_diam = new param_ed_arr(dial_control_par);
        ...
        ed_thick_lim_neg = new param_ed_arr(dial_control_par);
        ...
        ed_thick_lim_pos = new param_ed_arr(dial_control_par);
