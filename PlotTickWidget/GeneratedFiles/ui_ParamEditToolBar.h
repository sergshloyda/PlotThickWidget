...
public:
    ...
    QGroupBox *groupBox_defectoscop;
    QLabel *label_noConn;
    ...
    void setupUi(QWidget *ParamEditToolBar)
    {
        ...
        ParamEditToolBar->resize(227, 786);
        verticalLayout = new QVBoxLayout(ParamEditToolBar);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        groupBox_defectoscop = new QGroupBox(ParamEditToolBar);
        ...
        label_noConn = new QLabel(groupBox_defectoscop);
        label_noConn->setObjectName(QStringLiteral("label_noConn"));
        label_noConn->setGeometry(QRect(121, 0, 21, 21));
        QFont font1;
        font1.setPointSize(12);
        label_noConn->setFont(font1);
        label_noConn->setFrameShape(QFrame::Box);
        ...
        wid_menu_Layout->setGeometry(QRect(0, 30, 201, 28));
        ...
        checkBox_extra_strob_por->setFont(font2);
        ...
        label_por_1a_val->setFont(font2);
        ...
        label_por_2a_val->setFont(font2);
        ...
        frame_vrch->setGeometry(QRect(5, 420, 192, 56));
        ...
        button_copy = new PushButtonSel(frame);
        ...
        checkBox_vrch = new CheckBoxSel(groupBox_defectoscop);
        checkBox_vrch->setObjectName(QStringLiteral("checkBox_vrch"));
        checkBox_vrch->setGeometry(QRect(117, 426, 71, 20));
        checkBox_vrch->setFont(font2);
        checkBox_vrch->setLayoutDirection(Qt::RightToLeft);
        button_object_par = new PushButtonSel(groupBox_defectoscop);
        button_object_par->setObjectName(QStringLiteral("button_object_par"));
        button_object_par->setGeometry(QRect(3, 84, 101, 23));
        button_object_par->setFont(font2);
        button_object_par->setAutoDefault(true);
        button_object_par->setDefault(true);
        ed_thick_dt = new ParamLineEditSel(groupBox_defectoscop);
        ed_thick_dt->setObjectName(QStringLiteral("ed_thick_dt"));
        ed_thick_dt->setGeometry(QRect(145, 592, 46, 22));
        ed_thick_dt->setFont(font2);
        ed_thick_dt->setAlignment(Qt::AlignCenter);
        label_thick_dt = new QLabel(groupBox_defectoscop);
        label_thick_dt->setObjectName(QStringLiteral("label_thick_dt"));
        label_thick_dt->setGeometry(QRect(102, 596, 41, 16));
        label_thick_dt->setFont(font2);
        label_thick_corr = new QLabel(groupBox_defectoscop);
        label_thick_corr->setObjectName(QStringLiteral("label_thick_corr"));
        label_thick_corr->setGeometry(QRect(9, 596, 31, 16));
        label_thick_corr->setFont(font2);
        ed_thick_corr = new ParamLineEditSel(groupBox_defectoscop);
        ed_thick_corr->setObjectName(QStringLiteral("ed_thick_corr"));
        ed_thick_corr->setGeometry(QRect(44, 592, 46, 22));
        ed_thick_corr->setFont(font2);
        ed_thick_corr->setAlignment(Qt::AlignCenter);
        label_t_pr = new QLabel(groupBox_defectoscop);
        label_t_pr->setObjectName(QStringLiteral("label_t_pr"));
        label_t_pr->setGeometry(QRect(9, 543, 31, 16));
        label_t_pr->setFont(font2);
        label_cc = new QLabel(groupBox_defectoscop);
        label_cc->setObjectName(QStringLiteral("label_cc"));
        label_cc->setGeometry(QRect(113, 543, 31, 16));
        label_cc->setFont(font2);
        ed_cc = new ParamLineEditSel(groupBox_defectoscop);
        ed_cc->setObjectName(QStringLiteral("ed_cc"));
        ed_cc->setGeometry(QRect(145, 540, 46, 22));
        ed_cc->setFont(font2);
        ed_cc->setAlignment(Qt::AlignCenter);
        ed_t_pr = new ParamLineEditSel(groupBox_defectoscop);
        ed_t_pr->setObjectName(QStringLiteral("ed_t_pr"));
        ed_t_pr->setGeometry(QRect(44, 540, 46, 22));
        ed_t_pr->setFont(font2);
        ed_t_pr->setAlignment(Qt::AlignCenter);
        ed_alpha = new ParamLineEditSel(groupBox_defectoscop);
        ed_alpha->setObjectName(QStringLiteral("ed_alpha"));
        ed_alpha->setGeometry(QRect(44, 566, 46, 22));
        ed_alpha->setFont(font2);
        ed_alpha->setAlignment(Qt::AlignCenter);
        label_alpha = new QLabel(groupBox_defectoscop);
        label_alpha->setObjectName(QStringLiteral("label_alpha"));
        label_alpha->setGeometry(QRect(27, 569, 16, 16));
        label_alpha->setFont(font2);
        checkBox_chan_us_set = new CheckBoxSel(groupBox_defectoscop);
        checkBox_chan_us_set->setObjectName(QStringLiteral("checkBox_chan_us_set"));
        checkBox_chan_us_set->setGeometry(QRect(89, 114, 101, 20));
        checkBox_chan_us_set->setFont(font2);
        checkBox_chan_us_set->setLayoutDirection(Qt::RightToLeft);
        checkBox_scale_mode = new CheckBoxSel(groupBox_defectoscop);
        checkBox_scale_mode->setObjectName(QStringLiteral("checkBox_scale_mode"));
        checkBox_scale_mode->setGeometry(QRect(9, 614, 185, 21));
        checkBox_scale_mode->setFont(font2);
        checkBox_scale_mode->setLayoutDirection(Qt::LeftToRight);
        label_n_rez = new QLabel(groupBox_defectoscop);
        label_n_rez->setObjectName(QStringLiteral("label_n_rez"));
        label_n_rez->setGeometry(QRect(112, 594, 41, 20));
        label_n_rez->setFont(font2);
        ed_n_rez = new ParamLineEditSel(groupBox_defectoscop);
        ed_n_rez->setObjectName(QStringLiteral("ed_n_rez"));
        ed_n_rez->setGeometry(QRect(156, 592, 21, 22));
        ed_n_rez->setFont(font2);
        ed_n_rez->setAlignment(Qt::AlignCenter);
        pushButt_debug = new QPushButton(groupBox_defectoscop);
        pushButt_debug->setObjectName(QStringLiteral("pushButt_debug"));
        pushButt_debug->setGeometry(QRect(100, 582, 61, 23));
        pushButt_debug->setFont(font4);
        label_queue_len = new QLabel(groupBox_defectoscop);
        label_queue_len->setObjectName(QStringLiteral("label_queue_len"));
        label_queue_len->setGeometry(QRect(105, 568, 90, 16));
        label_queue_len->setFont(font2);
        button_reset_coord = new PushButtonSel(groupBox_defectoscop);
        button_reset_coord->setObjectName(QStringLiteral("button_reset_coord"));
        button_reset_coord->setGeometry(QRect(140, 635, 51, 26));
        button_reset_coord->setFont(font4);
        button_reset_coord->setAutoDefault(true);
        label_coord_units_descr = new QLabel(groupBox_defectoscop);
        label_coord_units_descr->setObjectName(QStringLiteral("label_coord_units_descr"));
        label_coord_units_descr->setGeometry(QRect(114, 636, 21, 21));
        label_coord_units_descr->setFont(font2);
        label_coord = new QLabel(groupBox_defectoscop);
        label_coord->setObjectName(QStringLiteral("label_coord"));
        label_coord->setGeometry(QRect(61, 636, 51, 21));
        label_coord->setFont(font2);
        label_coord->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        label_coord_descr = new QLabel(groupBox_defectoscop);
        label_coord_descr->setObjectName(QStringLiteral("label_coord_descr"));
        label_coord_descr->setGeometry(QRect(7, 637, 131, 21));
        label_coord_descr->setFont(font2);
        ...
        frame_b_scan->setGeometry(QRect(5, 293, 192, 56));
        ...
        ed_b_stepr->setFont(font2);
        ed_b_stepr->setAlignment(Qt::AlignCenter);
        pushButton_start_stop = new QPushButton(groupBox_defectoscop);
        pushButton_start_stop->setObjectName(QStringLiteral("pushButton_start_stop"));
        pushButton_start_stop->setGeometry(QRect(10, 690, 101, 23));
        pushButton_start_stop->setFont(font2);
        pushButton_start_stop->setCheckable(true);
        pushButton_start_stop->setAutoDefault(true);
        pushButton_start_stop->setDefault(false);
        pushButton_save_osc = new QPushButton(groupBox_defectoscop);
        pushButton_save_osc->setObjectName(QStringLiteral("pushButton_save_osc"));
        pushButton_save_osc->setGeometry(QRect(10, 720, 61, 23));
        pushButton_save_osc->setFont(font2);
        ed_osc_capt = new QLineEdit(groupBox_defectoscop);
        ed_osc_capt->setObjectName(QStringLiteral("ed_osc_capt"));
        ed_osc_capt->setGeometry(QRect(80, 722, 113, 20));
        ed_osc_capt->setFont(font2);
        label_signal_defect = new QLabel(groupBox_defectoscop);
        label_signal_defect->setObjectName(QStringLiteral("label_signal_defect"));
        label_signal_defect->setGeometry(QRect(132, 60, 21, 21));
        label_signal_defect->setFont(font1);
        ...
        label_a_des_2 = new QLabel(groupBox_defectoscop);
        label_a_des_2->setObjectName(QStringLiteral("label_a_des_2"));
        label_a_des_2->setGeometry(QRect(85, 59, 51, 21));
        label_a_des_2->setFont(font2);
        label_signal_ak = new QLabel(groupBox_defectoscop);
        label_signal_ak->setObjectName(QStringLiteral("label_signal_ak"));
        label_signal_ak->setGeometry(QRect(53, 59, 21, 21));
        label_signal_ak->setFont(font1);
        ...
        label_a_des = new QLabel(groupBox_defectoscop);
        label_a_des->setObjectName(QStringLiteral("label_a_des"));
        label_a_des->setGeometry(QRect(30, 59, 21, 21));
        label_a_des->setFont(font2);
        frame_b_scan->raise();
        label_coord_descr->raise();
        label_coord->raise();
        ...
        frame_strob->raise();
        frame_vrch->raise();
        checkBox_param_pos_edit->raise();
        frame->raise();
        checkBox_vrch->raise();
        label_noConn->raise();
        button_object_par->raise();
        ed_thick_dt->raise();
        label_thick_dt->raise();
        label_thick_corr->raise();
        ed_thick_corr->raise();
        label_t_pr->raise();
        label_cc->raise();
        ed_cc->raise();
        ...
        ed_alpha->raise();
        label_alpha->raise();
        checkBox_chan_us_set->raise();
        checkBox_scale_mode->raise();
        label_n_rez->raise();
        ed_n_rez->raise();
        pushButt_debug->raise();
        label_queue_len->raise();
        button_reset_coord->raise();
        label_coord_units_descr->raise();
        pushButton_start_stop->raise();
        pushButton_save_osc->raise();
        ed_osc_capt->raise();
        label_signal_defect->raise();
        label_a_des_2->raise();
        label_signal_ak->raise();
        label_a_des->raise();
