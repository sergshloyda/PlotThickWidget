...
QT_MOC_LITERAL(4, 37, 28),
QT_MOC_LITERAL(5, 66, 3)
    },
    "c_udp_cmd\0udp_ready_dat\0\0socketError\0"
...
const QMetaObject c_udp_cmd::staticMetaObject = {
    { &c_base_cmd::staticMetaObject, qt_meta_stringdata_c_udp_cmd.data,
...
void *c_udp_cmd::qt_metacast(const char *_clname)
{
    ...
    return c_base_cmd::qt_metacast(_clname);
}

int c_udp_cmd::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = c_base_cmd::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
