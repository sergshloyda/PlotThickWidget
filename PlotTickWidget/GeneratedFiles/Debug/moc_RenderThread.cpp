...
QT_MOC_LITERAL(10, 58, 20),
QT_MOC_LITERAL(11, 79, 4)
    },
    "RenderThread\0finished\0\0error\0err\0"
    "onDraw\0img\0rendering\0w\0h\0QList<Element_Info*>\0"
    "list"
};
...
void RenderThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onDraw((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        case 3: _t->rendering((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< QList<Element_Info*>(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (RenderThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenderThread::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (RenderThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenderThread::error)) {
                *result = 1;
            }
        }
        {
            typedef void (RenderThread::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RenderThread::onDraw)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 1
void RenderThread::error(QString _t1)
{
...
// SIGNAL 2
void RenderThread::onDraw(const QImage & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
